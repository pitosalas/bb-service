...
//
// $Id: ScheduledUpdateTask.java,v 1.3 2007/09/06 10:48:34 alg Exp $
//
...
/** Task for updating blogs information on a schedule basis. */
public class ScheduledUpdateTask extends BasicBlogUpdateTask
{
    private static final String NAME = "Scheduled Updates";
    private final long minimumPause;
    ...
    private final BlogsQueueCache queue = new BlogsQueueCache(ANTI_THROTTLING_PERIOD)
    {
        protected List<Blog> fetchNewItems()
        {
            ...
            return blogDao.findBlogsUpdatedBefore(time, CACHE_SIZE);
        }
    };
     ...
     */
    protected ScheduledUpdateTask(IBlogDiscoverer aDiscoverer, IBlogDao aBlogDao,
                                  IBlogLinkDao aBlogLinkDao, long aMinimumPause, long aTaskPeriod)
    {
